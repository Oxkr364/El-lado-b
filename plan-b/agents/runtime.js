...
export function runStoryAgents(input) {
  ...
  if (!input.consent && images.length) archiveErrors.push('Debes confirmar que puedes utilizar las fotografías.');
  ...
  const generated = {
    ...
    imageCount: images.length, pages, createdAt: new Date().toISOString()
  };
